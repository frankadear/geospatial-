...
const wmsBaseUrl = "http://localhost:8080"; // "http:192.168.43.35"; // "http://172.20.10.2"; // or http://localhost:8090";
...
export function useOpenLayers() {
  ...
  const layers = [
    ...
    new TileLayer({
      source: new TileWMS({
        url: `${wmsBaseUrl}/geoserver/frankageoserver/wms`,
        params: { LAYERS: "frankageoserver:countriesdbpedia", TILED: true },
